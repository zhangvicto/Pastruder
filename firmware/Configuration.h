...
#define CUSTOM_MACHINE_NAME "Pastruder Monster"
...
// TOP VIEW OF NOZZLES (Z pattern for numbering)
// |Head1|Head2|
// |Head3|Head4|

#define HOTEND_OFFSET_X { 0.0, 33.0, 0.0, 33.0 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, 0.0, 30.0, 30.0 }  // (mm) relative Y-offset for each nozzle
